...
def dqo():
    ...
    st.markdown("### Padronização do SFA 0,25 eqg/L")
    st.markdown("**Padrão primário:** Dicromato de Potássio")
    st.divider()
    ...
    concentracao_padrao = st.number_input(
        "Concentração do padrão (eqg/L)",
        value=0.254040,
        format="%.6f"
    )
